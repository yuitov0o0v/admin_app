...
CREATE OR REPLACE FUNCTION "public"."snapshot_spot_visit_names"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
...
ALTER FUNCTION "public"."snapshot_spot_visit_names"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_event_spots_transaction"("p_event_id" "uuid", "p_spot_ids" "uuid"[]) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_event_spots_transaction"("p_event_id" "uuid", "p_spot_ids" "uuid"[]) OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."view_user_profile_with_age" WITH ("security_invoker"='on') AS
 SELECT "id",
    "user_id",
    "email",
    "username",
...
ALTER VIEW "public"."view_user_profile_with_age" OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "on_spot_visit_insert" BEFORE INSERT ON "public"."spot_visit" FOR EACH ROW EXECUTE FUNCTION "public"."snapshot_spot_visit_names"();



CREATE OR REPLACE TRIGGER "protect_role_change" BEFORE UPDATE ON "public"."user_profile" FOR EACH ROW EXECUTE FUNCTION "public"."protect_role_column"();
...
GRANT ALL ON FUNCTION "public"."snapshot_spot_visit_names"() TO "anon";
GRANT ALL ON FUNCTION "public"."snapshot_spot_visit_names"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."snapshot_spot_visit_names"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_event_spots_transaction"("p_event_id" "uuid", "p_spot_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."update_event_spots_transaction"("p_event_id" "uuid", "p_spot_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_event_spots_transaction"("p_event_id" "uuid", "p_spot_ids" "uuid"[]) TO "service_role";
...
GRANT ALL ON TABLE "public"."view_user_profile_with_age" TO "anon";
GRANT ALL ON TABLE "public"."view_user_profile_with_age" TO "authenticated";
GRANT ALL ON TABLE "public"."view_user_profile_with_age" TO "service_role";
