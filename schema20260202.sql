...
\restrict xmHnm56IzM2q5KRq27SZped3h5NZF9L766RCNNX9xfoCNw22qMHMhc9J8pvTodT
...
--
-- Name: objects Admins can delete AR models; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can delete AR models" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'ar-models'::text) AND public.is_admin()));


--
-- Name: objects Admins can delete event images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can delete event images" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'event-images'::text) AND public.is_admin()));


--
-- Name: objects Admins can delete spot images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can delete spot images" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'spot-images'::text) AND public.is_admin()));


--
-- Name: objects Admins can update AR models; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can update AR models" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'ar-models'::text) AND public.is_admin()));


--
-- Name: objects Admins can update event images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can update event images" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'event-images'::text) AND public.is_admin()));


--
-- Name: objects Admins can update spot images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can update spot images" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'spot-images'::text) AND public.is_admin()));


--
-- Name: objects Admins can upload AR models; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can upload AR models" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'ar-models'::text) AND public.is_admin()));


--
-- Name: objects Admins can upload event images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can upload event images" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'event-images'::text) AND public.is_admin()));


--
-- Name: objects Admins can upload spot images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins can upload spot images" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'spot-images'::text) AND public.is_admin()));


--
-- Name: objects Users can view AR models in use; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can view AR models in use" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'ar-models'::text) AND (public.is_admin() OR (EXISTS ( SELECT 1
...
--
-- Name: objects Users can view active spot images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can view active spot images" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'spot-images'::text) AND (public.is_admin() OR (EXISTS ( SELECT 1
   FROM public.spots
  WHERE ((spots.image_url = objects.name) AND (spots.is_active = true)))))));


--
-- Name: objects Users can view public event images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can view public event images" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'event-images'::text) AND (public.is_admin() OR (EXISTS ( SELECT 1
   FROM public.events
...
\unrestrict xmHnm56IzM2q5KRq27SZped3h5NZF9L766RCNNX9xfoCNw22qMHMhc9J8pvTodT
